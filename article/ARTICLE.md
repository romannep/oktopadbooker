...
===
Цифры перед названием счета ничего не значат. В отчете
счета сортируются по названию - цифры используются для 
того, чтобы счета шли в нужном порядке.
===
...
Тут мы можем попытаться осознать концепцию Активов и Пассивов.
...
дебиторка отрицательная, что значит что по сути это аванс:
не клиент должен компании, а компания клиенту. В активах
могут быть товарные остатки, материалы, основные средства и т.п.

Правая колонка - пассивы - некоторое обоснование того,
откуда же у нас взялись активы. Помимо кредиторки и расчетов с сотрудниками
там могут быть, например, займы. Все прочие остатки мы
можем списывать на счет Капитал - в большинстве случаев это будет корректно.
...
вычесть из конечного начальный капиталл и получить требуемую сумму
===
...
доходы и забываем что то учесть - мы об этом можем никогда не узнать.
